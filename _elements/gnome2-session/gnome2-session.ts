        ...
        <gtk2-menu-button label="Applications">
          ...
          <gtk2-menu-item label="Games"
            ...
            <gtk2-menu slot="submenu">
              ...
              <gtk2-menu-item label="Gnometris"
                              data-launch="gnometris"
                              icon="apps/gnome-gnometris"></gtk2-menu-item>
              <gtk2-menu-item label="Mines"
                              data-launch="mines"
                              icon="categories/applications-games"></gtk2-menu-item>
              <gtk2-menu-item label="Same GNOME"
                              data-launch="same-gnome"
                              icon="apps/gnome-samegnome"></gtk2-menu-item>
